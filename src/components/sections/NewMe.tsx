      ...
      <div ref={pinContainerRef} className="h-screen w-full overflow-hidden md:sticky md:top-0 relative">
        ...
        >
          ...
          <div ref={contentWrapperRef} className="absolute inset-0 w-full h-full">
            <div className="floating-image absolute w-[24.6vw] md:w-[12.3vw] aspect-[1/1.2] bottom-[10%] left-1/2 md:left-[8%] transform -translate-x-1/2 md:translate-x-0 -rotate-[7deg]">
            ...
            <div className="floating-image absolute w-[35.4vw] md:w-[17.7vw] aspect-[1.2/1] top-[8%] right-[10%] transform rotate-[6deg]">
            ...
            <div className="floating-image absolute w-[23vw] md:w-[11.5vw] aspect-[1/1.2] top-[5%] left-[38%]">
