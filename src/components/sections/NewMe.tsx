      ...
      <div ref={pinContainerRef} className="h-screen w-full overflow-hidden lg:sticky lg:top-0 relative">
        ...
        >
          ...
          <div ref={contentWrapperRef} className="absolute inset-0 w-full h-full">
            <div className="floating-image absolute w-[33vw] lg:w-[12.3vw] aspect-[1/1.2] bottom-[10%] left-1/2 lg:left-[5%] transform -translate-x-1/2 lg:translate-x-0 -rotate-[7deg]">
                <Image src="https://i.ibb.co/8D9VnyxZ/790b8980-17ce-4517-9d41-bd3a5008a7ef.jpg" alt="Woman with beautiful hair" fill className="object-cover" quality={100} />
            </div>
            <div className="floating-image absolute w-[51vw] lg:w-[17.7vw] aspect-[1.2/1] top-[11%] left-[5%] lg:left-auto lg:right-[10%] transform rotate-[6deg]">
                <Image src="https://i.ibb.co/v6xqgN14/440cc9b2-04fe-40e8-83e7-84d0e84b820f.jpg" alt="Beauty salon details" fill className="object-contain" quality={100} />
            </div>
            <div className="floating-image absolute w-[33vw] lg:w-[11.5vw] aspect-[1/1.2] top-[10%] left-[75%] lg:left-[38%] transform -translate-x-1/2 lg:translate-x-0">
                <Image src="https://i.ibb.co/pvCXs1fm/5a0c5da2-c0e2-4de6-be9f-3390f376e3e1.jpg" alt="Woman getting a beauty treatment" fill className="object-cover" quality={100} />
            </div>
          </div>
          ...
          <div className="w-full h-full flex items-center justify-center">
            <div
                className="relative z-10 w-full text-cream 
                           ...
                           lg:grid lg:grid-cols-[1fr_auto_1fr] lg:items-center lg:gap-x-8"
                style={{ paddingLeft: 'clamp(24px, 4vw, 80px)', paddingRight: 'clamp(24px, 4vw, 80px)' }}
            >
                <h2
                    ref={h2TextRef}
                    className="text-[5vw] lg:text-[3vw] lg:text-right leading-none font-display uppercase whitespace-pre-line"
                >
                    {'Задача\n'}<span style={{color: '#2A5C56'}}>KA<span ref={tRef}>T</span>SO:</span>
                </h2>
                
                <div className="text-center">
                    <p
                        className="text-[5vw] lg:text-[3vw] whitespace-pre-line font-display tracking-display uppercase"
                ...
                <p
                    ref={pTextRef}
                    className="text-[4vw] lg:text-[1.2vw] font-lora lg:text-right whitespace-pre-line text-cream"
