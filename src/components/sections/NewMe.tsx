      ...
      <div ref={pinContainerRef} className="h-screen w-full overflow-hidden md:sticky md:top-0 relative">
        ...
        >
          ...
          <div ref={contentWrapperRef} className="absolute inset-0 w-full h-full">
            {/* Image 1 */}
            <div className="floating-image absolute w-[14.41vw] aspect-[1/1.2] bottom-[10%] left-[10%] transform -rotate-[7deg]">
                <Image
            ...
            {/* Image 2 */}
            <div className="floating-image absolute w-[20.7vw] aspect-[1.2/1] top-[8%] right-[12%] transform rotate-[6deg]">
                <Image
