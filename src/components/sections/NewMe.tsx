      ...
      <div ref={pinContainerRef} className="h-screen w-full overflow-hidden md:sticky md:top-0 relative">
        ...
        >
          ...
          <div ref={contentWrapperRef} className="absolute inset-0 w-full h-full">
            <div className="floating-image absolute w-[33vw] md:w-[16vw] lg:w-[12.3vw] aspect-[1/1.2] bottom-[10%] left-1/2 md:left-[5%] transform -translate-x-1/2 md:translate-x-0 -rotate-[7deg]">
            ...
            <div className="floating-image absolute w-[51vw] md:w-[22vw] lg:w-[17.7vw] aspect-[1.2/1] top-[13%] left-[5%] md:left-auto md:right-[10%] transform rotate-[6deg]">
            ...
            <div className="floating-image absolute w-[33vw] md:w-[15vw] lg:w-[11.5vw] aspect-[1/1.2] top-[10%] left-[75%] md:left-[38%] transform -translate-x-1/2 md:translate-x-0">
