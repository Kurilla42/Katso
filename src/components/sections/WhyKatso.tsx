                    ...
                    {whyKatsoData.map((item, index) => (
                        ...
                        >
                            ...
                            {index === 0 && (
                                ...
                                <div className="absolute bottom-[10%] md:top-[42%] md:bottom-[2%] right-[13%] w-[54%] md:w-[42%] lg:w-[36%] flex items-stretch gap-2 z-20">
                            ...
                            {index === 1 && (
                                <>
                                    <div className="absolute top-[10%] md:top-[2%] md:bottom-[42%] right-[13%] w-[54%] md:w-[42%] lg:w-[36%] flex items-stretch gap-2 z-20">
                                        <div className="relative flex-1 aspect-[9/16]">
                                            <video
                                                className="w-full h-full object-cover rounded-sm"
                                                autoPlay
